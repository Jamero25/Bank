...
import Consulta.ListaCheques;
import Loguearse.Usuario;

/**
 * Servlet implementation class DirectorioCuentas
 */
@WebServlet("/DirectorioCuentas")
public class DirectorioCuentas extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DirectorioCuentas() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			listaContactos = ConsultaAfiliados.Afiliado(objeto);
