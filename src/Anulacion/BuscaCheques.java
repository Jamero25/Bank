...
public class BuscaCheques {
	public static LinkedList<Usuario>  Listado(Usuario objeto) throws SQLException{
		...
		try {
			...
			ResultSet resultado = insql.executeQuery("select * from TTSOLIC where cuenta='"+ objeto.getCuenta()+"' and descripcion='Solicitud Abierta'");
			while(resultado.next()){
				...
				objeto1.setIdcheque(resultado.getInt("id"));
