...
/**
 * Servlet implementation class detallado
 */
@WebServlet("/detallado")
public class detallado extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		parche = getServletContext().getRequestDispatcher("/posicion_detallada.jsp");
