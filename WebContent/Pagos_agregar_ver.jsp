...
<ul class="navegador" style="height: 534px; width: 307px; ">
 ...
 <div id="content">
<br><br>
Aquí encontrará todos los servicios propios adscritos a su cuenta, si desea agregar uno nuevo debe realizarlo en la opción Pagos > Directorio.
    
   <br><br><br>
   Si deja la opción por defecto se monstrarán todos los servicios<br><br>
   
  <form name="pagos_ver"  action='./Pagos' method="post" onsubmit="return pagina()">
   Tipo Servicio: <select name="servicio">
  <option selected value="Todos">TODOS</option>
  <option value="cantv">CANTV</option>
  <option value="electricidad">Electricidad</option>
  <option value="gas">PDVSA Gas</option>
</select>

    Status: <select name="status">
    <option selected value="Todos">Todos</option>
<option value="solvente"> Solvente</option>
<option value="pagar">Por pagar</option></select>
    <input type="hidden" name="cuenta" value="<%= objeto.getCuenta()%>">
    <input type="hidden" name="nombre" value="<%= objeto.getNombre() %>">
    
   <input type="submit" value="Actualizar" name="boton" id="boton"> 
  
  </form>
<div> 
<jsp:include page="pagos_ok.jsp" flush="true"/></div>
