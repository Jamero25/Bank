...
<script type="text/javascript">
var texto = <%= request.getParameter("rango")%>
if(texto == '2')
	{
	var mensaje = "Cantv";
	}
	if (texto == '3')
		{
		var mensaje = "Electricidad";
		}
	if (texto =='4')
	{
	var mensaje = "PDVSA GAS";
	}
</script>

<div id="content">
<br><br>
CONFIRMACIÓN Del Servicio a Agregar<br><br><br>
<form name="servicios_internos"  action='./agregarpago' method="post">
<table>
<tr>
<td align="center"><h3>Servicio:</h3> </td>
<td align="center"><h3>    <script type="text/javascript"> 
document.writeln(mensaje); 
</script><%= request.getParameter("rango") %>  </h3></td>
</tr>
<tr>
<td align="center"><h3>ID Contrato:</h3></td>
<td align="center"><h3><%= request.getParameter("contrato") %></h3></td>
</tr>
<tr>
...
<td align="center"><h3><%= request.getParameter("cedula") %></h3></td>
</tr>
<tr>
<td align="center"><h3>Alias:</h3></td>
<td align="center"><h3><%= request.getParameter("alias") %></h3></td>
</tr>
<tr>
<td align="center"><h3>Fecha de pago:</h3></td>
<td align="center"><h3><%= request.getParameter("dia") %></h3></td>
</tr>


</table>
 <input type="hidden" name="contrato" value="<%= request.getParameter("contrato")%>">
  <input type="hidden" name="beneficiario" value="<%= request.getParameter("Beneficiario")%>">
   <input type="hidden" name="cedula" value="<%= request.getParameter("cedula")%>">
    <input type="hidden" name="alias" value="<%= request.getParameter("alias")%>">
    <input type="hidden" name="cuenta" value ="<%= objeto.getCuenta()  %>">
    <input type="hidden" name="servicio" value ="<%= request.getParameter("rango") %>">
