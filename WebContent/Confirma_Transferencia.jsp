...
<form name="servicios_internos"  action='./agregarTransfer' method="post">
<table>
<tr>
<td align="center"><h3>Cuenta:</h3></td>
<td align="center"><h3><%= request.getParameter("cuentabene") %></h3></td>
</tr>
<tr>
...
<td align="center"><h3><%= request.getParameter("alias") %></h3></td>
 ...
 <input type="hidden" name="cuentabene" value="<%= request.getParameter("cuentabene")%>">
