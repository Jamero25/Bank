...
<%@page import="Telefonos.TraerDispositivos"%>
...
<div id="content">
<form name="Quitar" action="./Quitartlf" method="post">
<% 
LinkedList<Usuario> lista = TraerDispositivos.Listado(objeto);

if(lista.size()==0)
{ %>
Estimado usuario actualmente no cuenta con dispositivos afiliados a su cuenta.
<% }
else {%>
<table border="2" align="center">
<tr>
<td style="width: 250px; " BACKGROUND="verde.jpg">Sel.</td>
<td style="width: 250px; " BACKGROUND="verde.jpg">MAC</td>
...
{
	out.println("<tr>"); 
	 out.println("<td> <input type='radio' name='seleccion' id='seleccion' value='"+lista.get(i).getMac().trim()+"' onclick='document.Quitar.boton.disabled = false;' >");
	out.println("<td>"+lista.get(i).getMac().trim() +"</td>");
}}%>
...
{ %>     
<br><br>
	<p align="center"><input type="submit" name="boton" value="QUITAR" disabled="disabled"  style="color: blue; background:white; font-size: 40; font-family: verdana; width:80px; height:25px"></p>
	<br/>
<%} %>
	</form>
</div>
