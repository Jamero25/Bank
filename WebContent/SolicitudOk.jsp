...
<div id="content">
<div align="center"> <font face="verdana" size="4">SOLICITUD REALIZADA EXITOSAMENTE RECUERDE TIENE DOS DÍAS PARA RETIRAR EL CHEQUE EN LA AGENCIA ELEGIDA.
</font></div>
<form name="datos_imprimir"  action='./Imprimir2' method="post">
...
<p align="center"><font face="verdana" size="4"> Recuerde imprimir su comprobante para realizar el retiro del cheque.</font></p>
<br>
<div align="center"><input type="submit" value="Imprimir" style="color: blue; background:white; font-size: 40; font-family: verdana; width:80px; height:25px"></div>
