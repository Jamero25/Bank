...
<div id="content">
<br><br>
<form name="Confirma_transferencia"  action='./ConfirmacionTransferencia' method="post" onsubmit="return validarForm(this);">
<table>
<tr>
<td align="center"><h3>Cuenta a Transferir:</h3></td>
<td align="center"><h3><%= objeto.getCuentabene().trim() %></h3></td>
</tr>
<tr>
<td align="center"><h3>Monto a transferir :</h3></td>
...
<td align="center"><h3><%= objeto.getBeneficiario().trim() %></h3></td>
</tr>
<tr>
<td align="center"><h3>Cédula Beneficiario:</h3></td>
<td align="center"><h3><%= objeto.getCedulabene().trim() %></h3></td>
</tr>
<tr>
<td align="center"><h3>Clave especial:</h3></td>
<td align="center"><input id="claveespecial"  name="claveespecial" type="password">
</td>
</tr>
</table>
...
<input type="hidden" name="montotransferir" value ="<%= request.getParameter("montotransferir") %>">
